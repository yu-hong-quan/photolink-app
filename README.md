...
| **macOS 电脑端** | [⬇️ PhotoLink-1.1.3-prod-macos.dmg](https://github.com/yu-hong-quan/photolink-pc/raw/master/releases/PhotoLink-1.1.3-prod-macos.dmg) | macOS 磁盘镜像（配套 PC 仓库，已去白边） |
